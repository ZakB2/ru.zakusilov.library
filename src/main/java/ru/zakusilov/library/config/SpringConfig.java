package ru.zakusilov.library.config;
...
@Configuration
@ComponentScan("ru.zakusilov.library")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("ru.zakusilov.library.repository")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        managerFactoryBean.setPackagesToScan("ru.zakusilov.springMVCAppPeopleFromDBWithJPA.model");
